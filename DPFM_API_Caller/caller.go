...
import (
	...
	"data-platform-api-quotations-creates-rmq-kube/existence_conf"
...
func (c *DPFMAPICaller) headerCreate(
	...
	res, err := c.rmq.SessionKeepRequest(ctx, c.conf.RMQ.QueueToSQL()[0], map[string]interface{}{"message": headerData, "function": "QuotationsHeader", "runtime_session_id": sessionID})
	if err != nil {
